...
# for fc17
#mkdir -p $RPM_BUILD_ROOT%{_sysconfdir}/polkit-1/localauthority/20-org.d/
#cp %{SOURCE10} $RPM_BUILD_ROOT/%{_sysconfdir}/polkit-1/localauthority/20-org.d/
...
%{_datadir}/omf/mdm/
#for fc17
#%{_sysconfdir}/polkit-1/localauthority/20-org.d/10-consolekit.pkla
